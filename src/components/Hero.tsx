      ...
      <div className="container mx-auto px-4 md:px-8 z-10 flex flex-col md:flex-row items-center justify-between py-20 md:py-0">
        <div className="hero-content w-full md:w-1/2 mb-12 md:mb-0 text-center md:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start animate-delay-200">
            <a href="#products" className="inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-burgundy hover:bg-burgundy-light focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-burgundy transition-all">
              Explore Products
              <ArrowRight className="ml-2 h-5 w-5" />
            </a>
            <a href="#contact" className="inline-flex items-center justify-center px-6 py-3 border border-burgundy rounded-md text-base font-medium text-burgundy bg-transparent hover:bg-burgundy/5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-burgundy transition-all">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center p-6 md:p-8">
                  <div className="w-36 h-36 sm:w-48 sm:h-48 mx-auto mb-4 rounded-full bg-burgundy/5 flex items-center justify-center">
                    <img src="/lovable-uploads/95f9abca-d08f-4b34-9662-9ba1ab31ca2d.png" alt="Prezzie Bazaar Logo" className="w-28 h-28 sm:w-40 sm:h-40 object-fill" />
                  </div>
